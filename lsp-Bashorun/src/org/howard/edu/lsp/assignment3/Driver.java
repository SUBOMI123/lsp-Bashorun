...
public class Driver {
    public static void main(String[] args) {
        ...
        comb.calculate_combinations(result, arr1, new ArrayList<Integer>(), target1, 0);
        // Print the answers
        System.out.println("Input: "+ Arrays.toString(arr1)+" Sum: "+ target1);
        System.out.println("Combinations: ");
        comb.printSets(result);

        // Declare array 2
        int arr2[] = {1, 2, 3, 4, 5, 6};
        int target2 = 6;    // Assign target sum
        result.clear();     // Clear answer

        // Find the sets and store them in the answer
        comb.calculate_combinations(result, arr2, new ArrayList<Integer>(), target2, 0);
        // Print the answers
     ...
     // Declare array 3
        ...
        // Find the sets and store them in the answer
        comb.calculate_combinations(result, arr3, new ArrayList<Integer>(), target3, 0);
        // Print the answers
     ...
     // Declare array 4
        ...
        // Find the sets and store them in the answer
        comb.calculate_combinations(result, arr4, new ArrayList<Integer>(), target4, 0);
        // Print the answers
